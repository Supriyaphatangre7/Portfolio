        ...
        <>
            ...
            <div className=" bg-white py-12 px-6 md:px-20">
                ...
                <p className="text-center text-gray-600 max-w-2xl mx-auto mb-10">
                    This project is a comprehensive event management system designed to simplify planning, organizing, and managing events. Built using PHP and MySQL, it allows users to register, create events, manage attendees, send invitations, and track event progress. It streamlines communication and coordination, making event execution more efficient and user-friendly.
                </p>
